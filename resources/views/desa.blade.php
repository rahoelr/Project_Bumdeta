            ...
            <div class="row">
                <form action="/sort-desa" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        $i = 100;
                        @endphp
                        @for ($i = 0; $i < count($responseBody["data"]); $i++) <div class="col-4 mb-2"
                            data-aos="fade-up">
                            <input type="checkbox" name="kecamatan[]" id="{{$responseBody["data"][$i]["kecamatan"]}}"
                                value="{{$responseBody["data"][$i]["kecamatan"]}}"><span class="inpt-sort">Kecamatan
                                {{$responseBody["data"][$i]["kecamatan"]}}</span>
                    </div>
                    @endfor
            </div>
