            ...
            <div class="content">
                ...
                <div class="kanan">
                    ...
                    <div class="name">
                        ...
                        is-invalid
                    @enderror" placeholder="Masukkan Deskripsi Organisasi" name="description" id="description"
                            rows="5"></textarea>
                        <div class="desc">
                    ...
                    @enderror" placeholder="Masukkan Makna Logo Organisasi" name="logo_meaning" id="logo_meaning"
                        ...
                        is-invalid
                    @enderror" placeholder="Masukkan Visi Organisasi" name="visi" id="visi" rows="5"></textarea>
                        </div>
                        <div class="desc">
                            <label for="misi">Misi</label>
                            <textarea class="deskripsi @error('misi')
                        is-invalid
                    @enderror" placeholder="Masukkan Misi Organisasi" name="misi" id="misi" rows="5"></textarea>
                        </div>
                    </div>
                </div>
